...
public class WindTrailRenderer : MonoBehaviour
{
    ...
    public float offsetMod; //direction the points are moving
    ...
    void Update()
    {
        ...
        //move positions
        Vector3 diff = -((Camera.main.transform.position - transform.position).normalized + _levelMover.offsetDir.normalized * offsetMod)* velocity *  Time.deltaTime;
